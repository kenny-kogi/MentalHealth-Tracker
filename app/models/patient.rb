class Patient < ApplicationRecord
    ...
    validates :lastName, presence: true
     ...
     def self.getslepthoursdata(id)
        hours_slept_array = []
        sleepinghoursdata = Patient.find_by(id: id).moods.select("hours_slept", "created_at").last(10)
    ...
    def self.getaverageslepthours(id)
        sleepinghoursdata = Patient.find_by(id: id).moods.average("hours_slept").round
    end

    def self.getAverageofallMoodlevels(id)
        user = Patient.find_by(id: id)
